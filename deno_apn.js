async function handle(request, connInfo) {
    ...
    async function handleRequest(request, connInfo) {
      ...
      if (apiUrl.hostname === "rezka-ua.tv" || apiUrl.hostname === "hdrezka.ag" || apiUrl.hostname === "rezka-ua.tv" || apiUrl.hostname === "hdrezka.me" || apiUrl.hostname === "hdrezka.sh" || apiUrl.hostname === "hdrezka.cm" || apiUrl.hostname === "hdrezka.kim" || apiUrl.hostname === "hdrezka.la" || apiUrl.hostname === "rezka.pub" || apiUrl.hostname === "kinopub.me") {
